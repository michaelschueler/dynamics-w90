...
!--------------------------------------------------------------------------------------
   subroutine PES_Slab_MatrixElements_precomp(orbs,wann,nlayer,scwfs,radints,kvec,vectk,lam,Matel,gauge)
...
!--------------------------------------------------------------------------------------
   function PES_Slab_Intensity_precomp(orbs,wann,nlayer,scwfs,radints,kpar,wphot,pol,Epe,&
      ...
      call PES_Slab_MatrixElements(orbs,wann,nlayer,scwfs,radints,kvec,vectk,lam,matel,gauge=gauge_)
