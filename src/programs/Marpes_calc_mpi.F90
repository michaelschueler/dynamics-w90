   ...
   subroutine CalcPES_Bulk(me)
      ...
      do ik=1,me%Nk_loc
         ...
         if(me%lambda_mode) then
            ...
            !$OMP DO
            do iepe=1,me%Nepe
               me%spect(iepe,ik) = PES_Bulk_Intensity(me%ham,me%chis,me%lmax,me%bessel_integ,kpar,me%wphot,&
                  me%polvec,me%Epe(iepe),epsk,vectk,me%MuChem,me%lambda_esc,kz_red,me%eta_smear,&
            ...
            !$OMP DO
            do iepe=1,me%Nepe
               me%spect(iepe,ik) = PES_Bulk_Intensity(me%orbs,me%ham,me%chis,me%radints,kpar,me%wphot,&
                  me%polvec,me%Epe(iepe),epsk,vectk,me%MuChem,me%lambda_esc,kz_red,me%eta_smear,&
                  me%gauge,qphot=me%qphot,phi=me%phi_rot)
            end do
            !$OMP END DO
            !$OMP END PARALLEL
         end if            
   ...
   subroutine CalcPES_2D(me)
      ...
      do ik=1,me%Nk_loc
         ...
         if(me%lambda_mode) then
            ...
            !$OMP DO
            do iepe=1,me%Nepe
               me%spect(iepe,ik) = PES_Intensity(me%ham,me%chis,me%lmax,&
                  me%bessel_integ,kpar,me%wphot,me%polvec,me%Epe(iepe),epsk,vectk,&
                  me%MuChem,me%lambda_esc,me%eta_smear,qphot=me%qphot,phi=me%phi_rot)
            end do
            !$OMP END DO
            !$OMP END PARALLEL
         else
